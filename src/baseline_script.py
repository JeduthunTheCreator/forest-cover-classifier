...
def main():
    ...
    print("FOREST COVER CLASSIFICATION - BASELINE MODEL")
    print("="*50)
    ...
    try:
        ...
        save_confusion_matrix(y_test, y_pred_classes, model_name='Baseline Model')

        # plot_training curves
        plot_training_curves(history, model_name='Baseline Model')
